    ...
    <>
      <style jsx global>{`
        ...
        * {
        ...
        /* Hero video styles moved to globals.css (lines 401-474) */
        ...
        @media (max-width: 768px) {
          /* Force HubSpot form to show all content */
          .hs-form-frame,
          .hs-form-frame > div,
          .hsfc-FormWrapper,
          .hsfc-Form,
          .hsfc-Step,
          [data-hsfc-id="FormWrapper"],
          [data-hsfc-id="Step"] {
          ...
          /* Ensure nav buttons have adequate space */
          .hsfc-Step__Navigation {
